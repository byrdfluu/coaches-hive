        ...
        <section className="mt-10 grid gap-6 md:grid-cols-2">
          {plans.map((plan) => {
            ...
            return <article key={plan.key} className="rounded-3xl border border-[#191919] bg-white p-8 shadow-sm">
              ...
              <div className="mt-6 rounded-2xl border border-[#dcdcdc] bg-[#f5f5f5] p-5 text-sm leading-6 text-[#191919]"><p className="font-semibold">4% Coaches Hive platform fee on payments</p><p className="mt-1 text-[#4a4a4a]">Stripe&apos;s standard processing fees are separate. Parents and payers see one charge.</p></div>
