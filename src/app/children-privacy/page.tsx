...
export default function ChildrenPrivacyPage() {
  return <main className="page-shell public-page"><div className="relative z-10 mx-auto max-w-4xl px-6 py-16">
    ...
    <p className="mt-6 text-sm text-[#4a4a4a]">See also our <Link className="text-[#b80f0a] underline" href="/privacy">Privacy Policy</Link> and <Link className="text-[#b80f0a] underline" href="/subprocessors">Subprocessors</Link>.</p>
  </div></main>
}
