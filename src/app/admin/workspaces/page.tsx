...
export default function AdminWorkspacesPage() {
  ...
  const load = useCallback(async () => {
    ...
    setLoading(false)
  }, [query, type, status, showTestData])
