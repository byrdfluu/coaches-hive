...
export const AUTH_SENSITIVE_PATHS = ['/api/auth/login', '/api/auth/password-reset', '/api/auth/send-code', '/api/auth/signup']
...
const ADMIN_PAGE_PERMISSION_ENTRIES: ScopedAdminPermissionEntry[] = [
  ...
  { prefix: '/admin/payment-accounting', read: 'finance.read' },
  { prefix: '/admin/connect-accounts', read: 'finance.read' },
  { prefix: '/admin/billing-failures', read: 'finance.read' },
  { prefix: '/admin/orders', read: 'finance.read' },
  { prefix: '/admin/revenue', read: 'finance.read' },
  { prefix: '/admin/disputes', read: 'finance.read' },
  { prefix: '/admin/refunds', read: 'security.manage' },
  { prefix: '/admin/operations', read: 'operations.manage' },
  { prefix: '/admin/webhooks', read: 'operations.manage' },
  { prefix: '/admin/push-health', read: 'operations.manage' },
  { prefix: '/admin/mobile-handoffs', read: 'operations.manage' },
...
const ADMIN_API_PERMISSION_ENTRIES: ScopedAdminPermissionEntry[] = [
  ...
  { prefix: '/api/admin/payment-accounting', read: 'finance.read', write: 'finance.manage' },
  { prefix: '/api/admin/connect-accounts', read: 'finance.read', write: 'finance.manage' },
  { prefix: '/api/admin/billing-failures', read: 'finance.read', write: 'finance.manage' },
  ...
  { prefix: '/api/admin/refunds', read: 'security.manage', write: 'security.manage' },
  ...
  { prefix: '/api/admin/webhooks', read: 'operations.manage', write: 'operations.manage' },
  { prefix: '/api/admin/push-health', read: 'operations.manage', write: 'operations.manage' },
  { prefix: '/api/admin/mobile-handoffs', read: 'operations.manage', write: 'operations.manage' },
