...
export async function upsertPrimaryAthleteProfile({
  ...
  const payload = {
    ...
    status: 'active',
    full_name: fullName,
    avatar_url: updates.avatar_url ?? primaryProfile?.avatar_url ?? null,
    bio: updates.bio ?? primaryProfile?.bio ?? null,
    sport: updates.sport ?? primaryProfile?.sport ?? null,
    location: updates.location ?? primaryProfile?.location ?? null,
...
export async function updateAthleteProfile({
  ...
  const payload = {
    ...
    bio: updates.bio ?? existingProfile.bio ?? null,
    sport: updates.sport ?? existingProfile.sport ?? null,
    location: updates.location ?? existingProfile.location ?? null,
