...
export default function AthleteWaiversPage() {
  ...
  const standalone = pathname === '/waivers'
  ...
  return (
    <main className="page-shell">
      <div className="relative z-10 px-4 py-6 sm:px-6 sm:py-10">
        {!standalone ? <RoleInfoBanner role="athlete" /> : null}
        <div>
        ...
        <div className={`mt-6 grid items-start gap-6 ${standalone ? '' : 'lg:grid-cols-[200px_1fr]'}`}>
          {!standalone ? <AthleteSidebar /> : null}
