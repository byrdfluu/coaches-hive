  ...
  org: [
    {
      ...
      body: "You're running the program. Coaches Hive handles the coordination — teams, coaches, dues, rosters, and waivers in one place.",
    },
    {
      icon: '🎨',
      title: 'Set up your organization',
      body: 'Add your logo and org details so coaches and athletes know exactly where they\'ve landed.',
    ...
    },
    {
      ...
      body: 'Set what each coach and staff member can see and do. You stay in control of the whole program.',
      actionLabel: 'Set permissions →',
      actionHref: '/org/permissions',
    },
    {
      icon: '📈',
      title: "You're ready to run your program.",
      body: 'Create your first team, invite your coaches, and start collecting dues. Everything runs from your org dashboard.',
      actionLabel: 'View checklist →',
