-- Reconcile final production schema without replaying obsolete two-tier pricing
-- data rewrites from 20260817000000.
...
comment on column public.org_settings.processing_fee_rate is
  'Organization Stripe Connect platform fee as a decimal; default 0.04.';
